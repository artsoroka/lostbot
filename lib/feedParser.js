...
var getEpisodeTitle = function(str){
...
var checkForNewEpisodes = function(episodes){
    ...
    return new Promise(function(resolve, reject){
        ...
        db('shows')
            ...
            .whereIn('shows.title_eng', titles)
...
module.exports = function(url){
    ...
    .then(function(data){
        ...
        return _.map(episodes, function(episode, title){
            ...
            var episodeTitle = getEpisodeTitle(episode.text) || {};  
            return {
                title   : title,
    ...
    .then(function(newEpisodes){
        ...
        var episodes = newEpisodes.map(function(e){
            return {
                ...
                link       : e.link, 
                title      : e.epTitle.rus || null, 
                title_eng  : e.epTitle.eng || null
            };  
        }); 
